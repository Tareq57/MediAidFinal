...
const AllLabTests = () => {
  ...
  useEffect(() => {
    const fetchTests = async () => {
      ...
      const res1 = await fetch(`${BASE_URL}/mediLab/tests/search?${queryString}`, {
  ...
  return (
    <div className="flex">
      ...
      <div className="w-5/6 p-4">
        <h1 className="text-3xl font-bold my-8 pl-10">ALL Tests</h1>
        ...
        <div className="mx-4 my-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-4 ">
          {tests.map((test, index) => (
            <div
              key={index}
              className="bg-white p-4 rounded-md shadow-md hover:shadow-lg transition duration-100 ease-in-out"
            ...
            >
              ...
              <div className="mb-2">
                ...
                <p className="text-gray-500">Price: {test.price} </p>
              </div>
